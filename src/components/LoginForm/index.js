      ...
      <div className="login__wrapper">
        <div className="login__wrapper-fixed">
          <p className="login__logo">
            <img
              className="login__logo-image mobile-image-logo"
              src={sfuLoginImageMobile}
              width="54"
              height="61"
              alt="СФУ ЛОГО"
            />
            <img
              className="login__logo-image tablet-image-logo"
              src={sfuLoginImageTablet}
              width="117"
              height="226"
              alt="СФУ ЛОГО"
            />
            <span className="login__logo-title">
              АСУ
              <br />
              ИКИТ
            </span>
